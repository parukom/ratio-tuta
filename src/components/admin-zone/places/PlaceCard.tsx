...
export default function PlaceCard({ id, name, description, totalEarnings, teamPeopleCount, currency = 'EUR' }: Props) {
  return (
    <Link href={id ? `/dashboard/home/place/${id}` : '#'} className="block rounded-lg bg-white shadow-sm ring-1 ring-gray-200 transition hover:shadow-md dark:bg-white/5 dark:ring-white/10">
      <div className="border-t border-gray-200/50 px-4 py-6 sm:px-6 lg:px-8 dark:border-white/5 rounded-lg">
