        ...
        <header className="sticky top-0 z-10 lg:rounded-xl border-y lg:border border-gray-200 bg-white p-3 shadow-xs dark:border-white/10 dark:bg-gray-900">
            <div className="flex flex-col gap-4">
                <header className="w-full flex gap-4 flex-wrap items-center">
                    ...
                    <label className="hidden md:flex items-center gap-2 rounded-md px-2 py-1 text-sm text-gray-700 ring-1 ring-inset ring-gray-300 dark:text-gray-300 dark:ring-white/10">
                        <input type="checkbox" checked={inStock} onChange={(e) => setInStock(e.target.checked)} />
                        {t('header.inStock')}
                    </label>

                    <div className="ml-auto hidden md:flex items-center gap-1 rounded-md bg-gray-50 p-1 ring-1 ring-gray-200 dark:bg-white/5 dark:ring-white/10">
                ...
                {/* Desktop: filters row */}
                <footer className="hidden md:flex gap-4 flex-wrap">
