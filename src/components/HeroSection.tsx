                ...
                <div className="mx-auto max-w-2xl">
                    <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                        <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 dark:text-gray-400 dark:ring-white/10">
                            Private by default · Role-based access · Audit trail
                        </div>
                    </div>
                    <div className="text-center">
                        <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl dark:text-white">
                            A secure online notebook that does the math for you
                        </h1>
                        <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8 dark:text-gray-400">
                            Write, structure, and calculate in one place. Keep sensitive data protected, collaborate safely,
                            and let formulas handle the numbers.
                        </p>
