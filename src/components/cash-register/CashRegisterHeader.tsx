...
export const CashRegisterHeader: React.FC<Props> = ({
    ...
    return (
        <header className="sticky top-0 z-10 border-b border-gray-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 px-4 py-2.5 sm:px-6 lg:px-8 dark:border-white/5 dark:bg-gray-900/80">
