    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="sticky top-0 z-50 flex items-center gap-x-6 bg-gradient-to-t from-white to-transparent px-4 py-4 safe-top shadow-xs sm:px-6 lg:hidden dark:bg-gradient-to-t dark:from-gray-900 dark:transparent dark:shadow-none dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:border-b dark:before:border-white/10 dark:before:bg-black/10">
                    <button
                        type="button"
                ...
                <main className="lg:pl-72">
                    <div className="">
                        <div className="m:px-6 lg:px-8 lg:py-6">
                            {children}
                        </div>
                    </div>
                </main>
